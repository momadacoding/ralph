...
11. If checks pass, stage ALL changes with `git add -A` and commit with message: `feat: [Story ID] - [Story Title]`
    - You MUST use `git add -A` to ensure prd.json and progress.txt are included in the commit
